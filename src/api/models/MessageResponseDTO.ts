...
export interface MessageResponseDTO {
     ...
     * @memberof MessageResponseDTO
     */
    contentType: MessageResponseDTOContentTypeEnum;
    /**
     * 
 ...
 * @export
 */
export const MessageResponseDTOContentTypeEnum = {
    Text: 'TEXT',
    ImageUrl: 'IMAGE_URL'
} as const;
export type MessageResponseDTOContentTypeEnum = typeof MessageResponseDTOContentTypeEnum[keyof typeof MessageResponseDTOContentTypeEnum];
